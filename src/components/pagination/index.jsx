    ...
    return (
        <div>
            <ReactPaginate forcePage={page - 1} onPageChange={({selected}) => setPage(selected + 2)}
                           pageCount={pageCount}
                           nextLabel={<span><Image src={'/icons/arrow-right.svg'} alt={'right'} width={24} height={24} className={''}/></span>}
                           previousLabel={<span><Image src={'/icons/arrow-left.svg'} alt={'left'} width={24} height={24}/></span>} className={'flex justify-center my-2 items-center'}
